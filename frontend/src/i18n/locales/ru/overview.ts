export const overview = {
  ...
  projects: {
    ...
    autopilot: {
      ...
      description:
        'Политика автономного вождения, обученная с помощью обучения с подкреплением на датасете KITTI Vision Benchmark, объединяющая видеопоток камеры, облака точек LiDAR и данные IMU-сенсора OXTS.',
      stack: {
