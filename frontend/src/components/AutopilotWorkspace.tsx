  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 pb-12 lg:items-start">
      ...
      <div className="flex-1 min-w-0 space-y-6">
        <ProjectSection id="overview" title={t('common.projectSections.overview')} icon={Car} accentClassName={ACCENT}>
          {/* Top Banner */}
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-2 mt-6">
            ...
            <p className="text-sm text-slate-400 max-w-3xl">{t('autopilot.roleContribution.body')}</p>
          </div>
        </ProjectSection>
